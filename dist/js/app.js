(() => {
                ...
                if (spollerItems.length) spollerItems.forEach((spollerItem => {
                    ...
                    if (hideSpollerBody) {
                        ...
                        if (!spollerItem.hasAttribute("data-open")) {
                            ...
                            if (spollerContent) spollerContent.hidden = true;
                        } else {
                        ...
                        spollerItem.open = true;
                        if (spollerContent) spollerContent.hidden = false;
                    }
                }));
            }
    ...
    function initSliders() {
        if (document.querySelector(".recom__slider")) new swiper_core_Swiper(".recom__slider", {
            ...
            navigation: {
                prevEl: ".recom__arrow--prev",
                nextEl: ".recom__arrow--next"
            },
            on: {}
        });
    }
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        if (window.innerWidth >= 991.98) document.querySelectorAll(".spollers-menu__title a").forEach((link => {
            link.addEventListener("click", (function(e) {
                e.stopPropagation();
            }));
        }));
        if (window.innerWidth <= 767.98) document.querySelector(".title-link-sp a").addEventListener("click", (function(e) {
            e.stopPropagation();
        }));
        const searchLabel = document.querySelector(".search__label");
        const searchButton = document.querySelector(".search__button");
        if (searchLabel !== null) searchButton.addEventListener("click", (() => {
        ...
        function updatePadding() {
            ...
            if (header && content) content.style.paddingTop = `${header.offsetHeight}px`;
        }
